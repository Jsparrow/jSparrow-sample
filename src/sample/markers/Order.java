...
public class Order {
	...
	public String testConvertMultipleCollections(List<String> resultList1, List<String> resultList2, List<String> resultList3){
	...
	public void checkingMarkers() {
		...
		logger.debug("This is a value " + r.toString());
		logger.debug("This is a value {}", r);
